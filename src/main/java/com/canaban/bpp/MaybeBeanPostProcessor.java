 ...
 */
@Component
public class MaybeBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String s) throws BeansException {
        ...
        if (clazz.isAnnotationPresent(RestController.class) || clazz.isAnnotationPresent(Controller.class)) {
            return Enhancer.create(clazz, (InvocationHandler) (o, method, objects) -> {
                if (method.getReturnType().equals(Maybe.class)) {
                    Maybe maybe = (Maybe) method.invoke(bean, objects);
